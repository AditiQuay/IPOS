 ...
 * the measure pass.
 */
public class LinearLayoutManagerDummy extends android.support.v7.widget.LinearLayoutManager {
    ...
    public LinearLayoutManagerDummy(Context context) {
        super(context);
    }

    @SuppressWarnings("UnusedDeclaration")
    public LinearLayoutManagerDummy(Context context, int orientation, boolean reverseLayout) {
