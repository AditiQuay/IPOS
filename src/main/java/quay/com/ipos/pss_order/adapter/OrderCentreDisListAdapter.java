...
public class OrderCentreDisListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public OrderCentreDisListAdapter(Context ctx, View.OnClickListener mClickListener, RecyclerView mRecycler,
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                return new OrderCentreDisListAdapter.UserViewHolder(view);
            }
            else if (viewType == VIEW_TYPE_LOADING) {
                View view =
                        LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                                parent, false); return new OrderCentreDisListAdapter.LoadingViewHolder(view); }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof OrderCentreDisListAdapter.UserViewHolder) {
                OrderCentreModal str = mDataset.get(position);
                AppLog.e(OrderCentreDisListAdapter.class.getSimpleName(), Util.getCustomGson().toJson(str));
                OrderCentreDisListAdapter.UserViewHolder userViewHolder = (OrderCentreDisListAdapter.UserViewHolder) holder;
            ...
            else if (holder instanceof OrderCentreDisListAdapter.LoadingViewHolder) {
                OrderCentreDisListAdapter.LoadingViewHolder loadingViewHolder = (OrderCentreDisListAdapter.LoadingViewHolder) holder;
