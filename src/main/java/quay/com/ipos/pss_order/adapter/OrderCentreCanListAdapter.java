...
public class OrderCentreCanListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public OrderCentreCanListAdapter(Context ctx, View.OnClickListener mClickListener, RecyclerView mRecycler,
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                return new OrderCentreCanListAdapter.UserViewHolder(view);
            }
            else if (viewType == VIEW_TYPE_LOADING) {
                View view =
                        LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                                parent, false); return new OrderCentreCanListAdapter.LoadingViewHolder(view); }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof OrderCentreCanListAdapter.UserViewHolder) {
                OrderCentreModal str = mDataset.get(position);
                AppLog.e(OrderCentreCanListAdapter.class.getSimpleName(), Util.getCustomGson().toJson(str));
                OrderCentreCanListAdapter.UserViewHolder userViewHolder = (OrderCentreCanListAdapter.UserViewHolder) holder;
            ...
            else if (holder instanceof OrderCentreCanListAdapter.LoadingViewHolder) {
                OrderCentreCanListAdapter.LoadingViewHolder loadingViewHolder = (OrderCentreCanListAdapter.LoadingViewHolder) holder;
