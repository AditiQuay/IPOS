...
public class ItemsDetailsPOListAdapter extends RecyclerView.Adapter<ItemsDetailsPOListAdapter.SurveyViewHolder> {
    ...
    public void onBindViewHolder(SurveyViewHolder holder, int position) {
        ...
        holder.tvAmount.setText(mContext.getResources().getString(R.string.Rs)+" "+ Util.indianNumberFormat(stringArrayList.get(position).getPoItemAmount())+"");
        holder.tvGst.setText(mContext.getResources().getString(R.string.Rs)+" "+Util.indianNumberFormat(stringArrayList.get(position).getPoItemIGSTValue())+"");
        holder.tvQty.setText(stringArrayList.get(position).getPoItemQty()+"");
        holder.price.setText(mContext.getResources().getString(R.string.Rs)+" "+Util.indianNumberFormat(stringArrayList.get(position).getPoItemUnitPrice())+"");
