...
public class PinnedOrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    View.OnClickListener mOnClickListener;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                return new PinnedOrderAdapter.UserViewHolder(view);
            }
            else if (viewType == VIEW_TYPE_LOADING) {
                View view =
                        LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                                parent, false); return new PinnedOrderAdapter.LoadingViewHolder(view); }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof PinnedOrderAdapter.UserViewHolder) {
                NewOrderPinnedResults.Info str = mDataset.get(position);
                AppLog.e(PinnedOrderAdapter.class.getSimpleName(), Util.getCustomGson().toJson(str));
                ...
                PinnedOrderAdapter.LoadingViewHolder loadingViewHolder = (PinnedOrderAdapter.LoadingViewHolder) holder;
