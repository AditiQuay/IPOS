...
//                getTGrnDetails();
    ...
    private void inializeViews() {
        ...
        edtGSTValue = findViewById(R.id.edtGSTValues);
    ...
    private void getExpandableData(String response) {
        ...
        try {
            ...
            edtGSTValue.setText(getResources().getString(R.string.Rs)+" "+Util.indianNumberFormat(Util.round(jsonObject.optDouble("documentIGSTValue"), 2)) + "");
            edtDocValue.setText(getResources().getString(R.string.Rs)+" "+Util.indianNumberFormat(Util.round(jsonObject.optDouble("documentValue"), 2)) + "");
