...
public interface APIService {
    ...
    @POST(IPOSAPI.GET_ORDER_DETAIL)
    Call<DDROrderDetail> GET_ORDER_DETAIL(@Body PODetailReq poDetailReq);
    ...
    @POST(IPOSAPI.DDR_GETDDRBATCHUPDATEDETAIL)
    Call<DDRBatchMasterResponse> DDR_GETDDRBATCHUPDATEDETAIL(@Body DDRBatchReq req);
