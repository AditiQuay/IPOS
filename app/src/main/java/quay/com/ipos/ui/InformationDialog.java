...
//
//
//    public InformationDialog(Context mContext, String title, String message, String yesButton, String noButton)
//    {
//        super(mContext);
//        dismiss();
...
//
//    }
//    public MessageDialog(Context mContext, String title, String message, String yesButton, String noButton, String cancelButton, MessageDialog.MessageDialogListener listener, final int mCallType)
//    {
//        super(mContext);
//        dismiss();
//        this.mContext = mContext;
