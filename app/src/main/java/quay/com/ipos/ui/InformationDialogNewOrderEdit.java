...
public class InformationDialogNewOrderEdit extends Dialog
{
    Context mContext;
    RealmOrderCentre datum;
    ImageView imvClose;
    TextView tvHSN,tvGST,tvMRP,tvGPL,tvNRV,tvSalesPrice,tvCategory,tvSubCategory,tvBrand,tvCGST,tvSGST;
    LinearLayout llBrand;


    public InformationDialogNewOrderEdit(Context mContext, RealmOrderCentre datum)
    {
        super(mContext);
        dismiss();
