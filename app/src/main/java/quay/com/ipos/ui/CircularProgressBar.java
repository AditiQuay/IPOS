...
public class CircularProgressBar extends View {
    ...
    private int mProgressColor1 = Color.BLACK;   // Outline color
    ...
    private void drawOutlineArc1(Canvas canvas) {
        ...
        mPaint.setColor(mProgressColor1);
