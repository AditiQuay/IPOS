...
public class SearchableListDialog extends DialogFragment implements
    ...
    private CustomAdapterAddress adapter;
      ...
      adapter = new CustomAdapterAddress(getActivity(), R.layout.spinner_item_pss,R.id.text1,items);
        ...
        _listViewItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                _searchableItem.onSearchableItemClicked(adapter.getItem(position), position);
                getDialog().dismiss();
            }
        });
    }
...
//                _listViewItems.clearTextFilter();
            ((CustomAdapterAddress) _listViewItems.getAdapter()).getFilter().filter(null);
        } else {
            ((CustomAdapterAddress) _listViewItems.getAdapter()).getFilter().filter(s);
        }
