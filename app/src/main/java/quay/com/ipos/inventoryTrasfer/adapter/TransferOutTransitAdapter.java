...
public class TransferOutTransitAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public TransferOutTransitAdapter(Context ctx, View.OnClickListener mClickListener, RecyclerView mRecycler,
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                return new TransferOutTransitAdapter.UserViewHolder(view);
            }
            else if (viewType == VIEW_TYPE_LOADING) {
                View view =
                        LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                                parent, false); return new TransferOutTransitAdapter.LoadingViewHolder(view); }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof TransferOutTransitAdapter.UserViewHolder) {
                TransferOutListModal str = mDataset.get(position);
                TransferOutTransitAdapter.UserViewHolder userViewHolder = (TransferOutTransitAdapter.UserViewHolder) holder;
            ...
            else if (holder instanceof TransferOutTransitAdapter.LoadingViewHolder) {
                TransferOutTransitAdapter.LoadingViewHolder loadingViewHolder = (TransferOutTransitAdapter.LoadingViewHolder) holder;
