...
public class OutboxAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OutboxAdapter(Context ctx,
                         ArrayList<BillingSync> questionList) {
        this.mContext = ctx;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            return new OutboxAdapter.UserViewHolder(view);
        }
        else if (viewType == VIEW_TYPE_LOADING) {
            View view =
                    LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                            parent, false); return new OutboxAdapter.LoadingViewHolder(view); }
...
//            mPaymentDetail.addAll(printViewResult.getPaymentsDetails());
        ...
        else if (holder instanceof OutboxAdapter.LoadingViewHolder) {
            OutboxAdapter.LoadingViewHolder loadingViewHolder = (OutboxAdapter.LoadingViewHolder) holder;
