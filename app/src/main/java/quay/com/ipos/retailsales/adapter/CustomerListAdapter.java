...
public class CustomerListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            return new CustomerListAdapter.UserViewHolder(view);
        }
        else if (viewType == VIEW_TYPE_LOADING) {
            View view =
                    LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                            parent, false); return new CustomerListAdapter.LoadingViewHolder(view); }
...
//            userViewHolder.tvAdd.setTag(position);
        ...
        else if (holder instanceof CustomerListAdapter.LoadingViewHolder) {
            CustomerListAdapter.LoadingViewHolder loadingViewHolder = (CustomerListAdapter.LoadingViewHolder) holder;
