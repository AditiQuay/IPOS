...
public class RealmUserDetail extends RealmObject{
     ...
     * UserMenu : [{"I":[{"title":"Mostly Used","icon":"","child":[]},{"title":"Billing & Cash","icon":"","child":[{"name":"Retail Sales (OTC & Online)","icon":""},{"name":"DDR Sales (B2B)","icon":""},{"name":"Day Closure","icon":""},{"name":"Loyalty Program","icon":""},{"name":"Offer Discount","icon":""}]},{"title":"Manage Store","icon":"","child":[{"name":"Inventory In/Out","icon":""},{"name":"Asset In/Out","icon":""},{"name":"Store Expenses","icon":""},{"name":"Employee Management","icon":""}]},{"title":"Manage Business","icon":"","child":[{"name":"Miscellaneous Income","icon":""},{"name":"Expense & IV","icon":""},{"name":"Accounting & Settlements","icon":""},{"name":"Auto Bank Reconcillation","icon":""},{"name":"Secondary Sales Tracking","icon":""},{"name":"Compliance Tracking","icon":""}]},{"title":"Insights & Analytics","icon":"","child":[]}]},{"P":[{"title":"New Order","icon":"","child":[]},{"title":"Order Center","icon":"","child":[]},{"title":"Dashboard & Insights","icon":"","child":[]},{"title":"Product Catalogue","icon":"","child":[]},{"title":"Stock & Price","icon":"","child":[]},{"title":"Loyalty Program","icon":"","child":[]},{"title":"Partner Connect","icon":"","child":[]}]}]
     */
    @PrimaryKey
    private int Code;
