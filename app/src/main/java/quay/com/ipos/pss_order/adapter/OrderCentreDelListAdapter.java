...
public class OrderCentreDelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public OrderCentreDelListAdapter(Context ctx, View.OnClickListener mClickListener, RecyclerView mRecycler,
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                return new OrderCentreDelListAdapter.UserViewHolder(view);
            }
            else if (viewType == VIEW_TYPE_LOADING) {
                View view =
                        LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                                parent, false); return new OrderCentreDelListAdapter.LoadingViewHolder(view); }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof OrderCentreDelListAdapter.UserViewHolder) {
                OrderCentreModal str = mDataset.get(position);
                AppLog.e(OrderCentreDelListAdapter.class.getSimpleName(), Util.getCustomGson().toJson(str));
                OrderCentreDelListAdapter.UserViewHolder userViewHolder = (OrderCentreDelListAdapter.UserViewHolder) holder;
            ...
            else if (holder instanceof OrderCentreDelListAdapter.LoadingViewHolder) {
                OrderCentreDelListAdapter.LoadingViewHolder loadingViewHolder = (OrderCentreDelListAdapter.LoadingViewHolder) holder;
