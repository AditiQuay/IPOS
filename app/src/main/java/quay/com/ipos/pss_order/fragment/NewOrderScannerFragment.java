...
public class NewOrderScannerFragment extends BaseFragment implements
    ...
    public static NewOrderScannerFragment newInstance() {
        return new NewOrderScannerFragment();
    }
