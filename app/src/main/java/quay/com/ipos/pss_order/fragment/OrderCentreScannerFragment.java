...
public class OrderCentreScannerFragment extends BaseFragment implements
    ...
    public static OrderCentreScannerFragment newInstance() {
        return new OrderCentreScannerFragment();
    }
