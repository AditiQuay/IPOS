...
public class DDRDiscountNewOrderListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<DDRNewOrderProductsResult.DataBean.DiscountBean> mDataset;
    RecyclerView mRecyclerView;

    public DDRDiscountNewOrderListAdapter(Context ctx, RecyclerView mRecycler,
                                          List<DDRNewOrderProductsResult.DataBean.DiscountBean> questionList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            return new DDRDiscountNewOrderListAdapter.UserViewHolder(view);
        }
        else if (viewType == VIEW_TYPE_LOADING) {
            View view =
                    LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                            parent, false); return new DDRDiscountNewOrderListAdapter.LoadingViewHolder(view); }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof DDRDiscountNewOrderListAdapter.UserViewHolder) {
            DDRNewOrderProductsResult.DataBean.DiscountBean str = mDataset.get(position);
            DDRDiscountNewOrderListAdapter.UserViewHolder userViewHolder = (DDRDiscountNewOrderListAdapter.UserViewHolder) holder;
        ...
        else if (holder instanceof DDRDiscountNewOrderListAdapter.LoadingViewHolder) {
            DDRDiscountNewOrderListAdapter.LoadingViewHolder loadingViewHolder = (DDRDiscountNewOrderListAdapter.LoadingViewHolder) holder;
