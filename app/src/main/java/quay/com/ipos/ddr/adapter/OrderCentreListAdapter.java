...
public class OrderCentreListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                View view =
                        LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                                parent, false); return new OrderCentreListAdapter.LoadingViewHolder(view); }
