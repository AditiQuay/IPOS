...
public class OrderList  {
    ...
    double  totalGst=0.0, cgst = 0.0, sgst = 0.0,discountPrice=0.0,round_off=0.0;
    int discountItem=0;
    double totalAfterGSt=0.0,totalPrice=0.0;
...
//        }
    ...
    public double getTotalAfterGSt() {
        return totalAfterGSt;
    }

    public void setTotalAfterGSt(double totalAfterGSt) {
