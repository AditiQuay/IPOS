...
public class InformationDialogInventory extends Dialog
{
    Context mContext;
    NewOrderProductsResult.DataBean datum;
    ImageView imvClose;
    TextView tvHSN,tvGST,tvMRP,tvGPL,tvNRV,tvSalesPrice,tvCategory,tvSubCategory,tvBrand,tvCGST,tvSGST;
    LinearLayout llBrand;


    public InformationDialogInventory(Context mContext, NewOrderProductsResult.DataBean datum)
    {
        super(mContext);
        dismiss();
