...
public class KYCRelationShipFragment extends Fragment {
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private String mParam1;
    private String mParam2;

    private RelationShipFragment.OnFragmentInteractionListener mListener;
    ...
    public KYCRelationShipFragment() {

    }


    // TODO: Rename and change types and number of parameters
    public static KYCRelationShipFragment newInstance(String param1, String param2) {
        KYCRelationShipFragment fragment = new KYCRelationShipFragment();
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof RelationShipFragment.OnFragmentInteractionListener) {
            mListener = (RelationShipFragment.OnFragmentInteractionListener) context;
        } else {
