...
public class TransferOutShortAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public TransferOutShortAdapter(Context ctx, View.OnClickListener mClickListener, RecyclerView mRecycler,
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == VIEW_TYPE_ITEM) {
                ...
                return new TransferOutShortAdapter.UserViewHolder(view);
            }
            else if (viewType == VIEW_TYPE_LOADING) {
                View view =
                        LayoutInflater.from(mContext).inflate(R.layout.load_more_footer,
                                parent, false); return new TransferOutShortAdapter.LoadingViewHolder(view); }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            if (holder instanceof TransferOutShortAdapter.UserViewHolder) {
                TransferOutListModal str = mDataset.get(position);
                TransferOutShortAdapter.UserViewHolder userViewHolder = (TransferOutShortAdapter.UserViewHolder) holder;
            ...
            else if (holder instanceof TransferOutShortAdapter.LoadingViewHolder) {
                TransferOutShortAdapter.LoadingViewHolder loadingViewHolder = (TransferOutShortAdapter.LoadingViewHolder) holder;
