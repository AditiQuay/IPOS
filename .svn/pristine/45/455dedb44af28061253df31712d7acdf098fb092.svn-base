...
/**
 * Created by niraj.kumar on 6/6/2018.
 */
...
public class AddCustomerModel {
     ...
     * custoemrGstin : string
     * customerStatus : string
     * customerDesignation : string
     * customerSpouseFirstName : string
     * customerSpouseLastName : string
     * customerSpouseDob : string
     * customerChildSatus : string
     * customerChild : [{"customerChildFirstName":"string","customerChildLastName":"string","customerChildGender":"string","customerChildDob":"string"}]
     ...
     * registeredBusinessPlaceID : string
     * isSync : 0
     */
