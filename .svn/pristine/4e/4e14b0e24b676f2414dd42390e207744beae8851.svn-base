...
public class TransferInDetailsActivity extends AppCompatActivity implements InitInterface, View.OnClickListener, MyListener, DataUpdateListener {
    ...
    private RelativeLayout rGrnHeader;
    private TextView tvGrnNumber;
    ...
    public void findViewById() {
        ...
        rGrnHeader = findViewById(R.id.rGrnHeader);
        tvGrnNumber = findViewById(R.id.tvGrnNumber);
...
//        }
        ...
        if (realmTransferDetail != null) {
            try {
                ...
                if (TextUtils.isEmpty(realmTransferDetail.getGrnNumber())) {
                    rGrnHeader.setVisibility(View.GONE);
                } else {
                    rGrnHeader.setVisibility(View.VISIBLE);
                    tvGrnNumber.setText("GRN For" + " " + realmTransferDetail.getGrnNumber());
                }
